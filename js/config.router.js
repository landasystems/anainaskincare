                ...
                ['$rootScope', '$state', '$stateParams', 'Data',
                    function ($rootScope, $state, $stateParams, Data) {
                        ...
                        $rootScope.$on("$stateChangeStart", function (event, toState) {
                            var globalmenu = ['app.dashboard', 'master.userprofile', 'access.signin', 'master.barang', 'transaksi.coba'];
...
//                                })
                                ...
                                .state('laporan.barang', {
                                    url: '/barang',
                                    params: {'form': null},
                                    templateUrl: 'tpl/l_barang/index.html',
                                    resolve: {
                                        deps: ['$ocLazyLoad',
                                            function ($ocLazyLoad) {
                                                return $ocLazyLoad.load('js/controllers/l_barang.js');
                                            }]
                                    }
                                })
