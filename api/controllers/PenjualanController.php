...
class PenjualanController extends Controller
{
    ...
    public function actionGetdiskon()
    {
        ...
        if (empty($model)) {
            ...
            $data['type'] = 'Barang';
            $data['produk']       = array('id' => $model['id'], 'nama' => $model['nama']);
            $data['harga']        = (int) 0;
            $data['jumlah']       = (int) 1;
            $data['diskon']       = (int) 0;
            $data['diskonpersen'] = (int) 0;
            echo json_encode(array("s" => 1, "diskon" => $data));
        }
    }
    ...
    public function actionIndex()
    {
        ...
        $query->offset($offset)
            ...
            ->select('m_user.nama as petugas, penjualan.created_at, penjualan.created_by, m_cabang.nama as cabang, m_customer.nama as customer, penjualan.print, penjualan.kode as kode, penjualan.tanggal as tanggal,
